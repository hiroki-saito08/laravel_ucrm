                ...
                <div class="container px-5 py-8 mx-auto">
                  <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          <label class="mr-5 leading-7 text-sm text-gray-600">性別</label>
                          <label for="gender0" class="ml-2 mr-4 leading-7 text-sm text-gray-600">男</label>
                          <input type="radio" id="gender0" name="gender" v-model="form.gender" class="ml-2 mr-4" value="0">
                          <label for="gender1" class="ml-2 mr-4 leading-7 text-sm text-gray-600">女</label>
                          <input type="radio" id="gender1" name="gender" v-model="form.gender" class="ml-2 mr-4" value="1">
                          <label for="gender2" class="ml-2 mr-4 leading-7 text-sm text-gray-600">その他</label>
                          <input type="radio" id="gender2" name="gender" v-model="form.gender" class="ml-2 mr-4" value="2">
                        </div>
                      </div>
                      <div class="p-2 w-full">
                        <div class="relative">
