                  ...
                  <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                      <tr v-for="item in items" :key="item.id">
                        ...
                        <td class="border-b-2 border-gray-200 px-4 py-3" v-if="item.is_selling === 1">販売中</td>
                        <td class="border-b-2 border-gray-200 px-4 py-3" v-if="item.is_selling === 0">停止中</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
