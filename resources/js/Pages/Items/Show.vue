                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <div id="status" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 leading-8 transition-colors duration-200 ease-in-out">
                          <span class="px-4 py-3" v-if="item.is_selling === 1">販売中</span>
                          <span class="px-4 py-3" v-if="item.is_selling === 0">停止中</span>
                        </div>
                      </div>
                    </div>
