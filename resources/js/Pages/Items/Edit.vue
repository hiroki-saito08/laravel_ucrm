                    ...
                    <div class="flex flex-wrap -m-2">
                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" class="ml-2 mr-4" value="1">
                          <label class="ml-2 mr-4 leading-7 text-sm text-gray-600">販売中</label>
                          <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" class="ml-2 mr-4" value="0">
                          <label class="ml-2 mr-4 leading-7 text-sm text-gray-600">停止中</label>
                        </div>
                      </div>
